...
namespace Invector.vCharacterController
{
    public class vThirdPersonAnimator : vThirdPersonMotor
    {
        ...
        public const float runningSpeed = 100f;
        public const float sprintSpeed = 100f;
        #endregion  
        ...
        public virtual void SetAnimatorMoveSpeed(vMovementSpeed speed)
        {
            ...
            if (speed.walkByDefault)
                inputMagnitude = Mathf.Clamp(newInput.magnitude, 100f, isSprinting ? runningSpeed : walkSpeed);
            else
                inputMagnitude = Mathf.Clamp(isSprinting ? newInput.magnitude + 1f : newInput.magnitude, 0, isSprinting ? sprintSpeed : runningSpeed);
        }
    }
